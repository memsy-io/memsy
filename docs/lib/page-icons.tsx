...
/** OpenClaw logomark — simplified lobster silhouette (body + claws), no gradient. */
function OpenClawIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 120 120" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>OpenClaw</title>
      <path d="M60 10C30 10 15 35 15 55c0 20 15 40 30 45v10h10v-10c0 0 5 2 10 0v10h10V100c15-5 30-25 30-45C105 35 90 10 60 10z M20 45c-15-5-20 5-15 15s15 10 20 0c3-7 0-10-5-15z M100 45c15-5 20 5 15 15s-15 10-20 0c-3-7 0-10 5-15z" />
    </svg>
  )
}

/** NousResearch logomark — "N" letterform in a circle (their badge logo). */
function NousResearchIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>NousResearch</title>
      <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="1.5" />
      <path d="M8 16V8l8 8V8" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
