...
<CardGroup cols={2}>
  ...
  <Card title="Memsy Studio" icon="flask" href="/docs/studio">
    Try Memsy in the dashboard — drop text or documents in and watch them become memory, no code required.
  </Card>
  ...
  <Card title="Cookbooks" icon="gear" href="/docs/cookbooks">
    Runnable end-to-end recipes — Next.js, FastAPI, Slack, and tool-calling agents.
  </Card>
